                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            Intent i = null;
                            if(type=="startup")
                                i=new Intent(LoginActivity.this, StartupRegister.class);
                            if(type=="student")
                                i=new Intent(LoginActivity.this, StudentRegister.class);
                            if(type=="investor")
                                i=new Intent(LoginActivity.this, InvestorRegister.class);
